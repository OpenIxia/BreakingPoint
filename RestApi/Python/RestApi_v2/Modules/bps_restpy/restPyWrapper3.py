...
### this BPS REST API wrapper is generated for version: 9.37.0.184
class BPS(object):
    ...
    ### null
    @staticmethod
    def _topology_operations_setPortSettings(self, linkState, autoNegotiation, slotId, portId):
        """
        ...
        :param portId (string): 
        """
        return self._wrapper._post('/topology/operations/setPortSettings', **{'linkState': linkState, 'autoNegotiation': autoNegotiation, 'slotId': slotId, 'portId': portId})
